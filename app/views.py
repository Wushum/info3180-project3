...
def apiLogin():
    ...
    if user.validate():
        ...
        return jsonify(error=1, data={}, messsage="Username and password combination is bad")
...
def sendemail():
    ...
    fromaddr = 'winston13lindsay@gmail.com'
    ...
    if request.method == 'POST':
        ...
        server.starttls()
        server.login('winston13lindsay@gmail.com', 'yasdnil')
...
def sendemail():
    ...
    if request.method == 'POST':
        ...
        server.quit()
        return redirect(url_for('.home'))
    return render_template('FormEmail.html', form=contact, formname='FormEmail')    
